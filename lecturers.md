...
<section class="speakers-hero" aria-labelledby="speakers-title">
  <p class="speakers-eyebrow">TAROT 2026 faculty</p>
  <h1 id="speakers-title">Invited Speakers</h1>
  <p class="speakers-lede">Meet the researchers and industry experts shaping the programme on testing, verification, AI assurance, autonomous systems, and trustworthy software engineering.</p>
</section>

<section class="speakers-section" aria-labelledby="speaker-grid-title">
...
.section-heading-row .speakers-eyebrow {
  color: #92400e;
}
